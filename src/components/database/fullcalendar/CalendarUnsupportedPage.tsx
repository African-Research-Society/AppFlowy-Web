  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 max-sm:py-6 px-4">
      ...
      <p className="text-text-caption text-center mb-8 max-w-md">
        Calendar view is not supported on this device. For the best calendar experience, please download the ARS Workspace mobile app.
      </p>
      
      {/* Buttons */}
      <div className="flex flex-col max-sm:w-full sm:flex-row gap-3">
        <Button
          onClick={() => window.open('https://africanresearchsociety.org', '_blank')}
        >
          Download ARS Workspace
        </Button>
        <Button
          variant="outline"
